...
export type Statement = "Empty" | { "Block": Array<Statement> } | { "Conditional": ConditionalStatement } | { "While": { condition: BooleanExpression, body: Array<Statement>, } } | { "Broadcast": { msg: string, to: PlayerCollectionExpression, } } | { "DeclareWinner": PlayerCollectionExpression } | { "SetNumber": { name: string, value: NumberExpression, } } | { "AdvancePlayerStateByType": { to_advance: NumberExpression, type_name: string, } } | { "AdvancePlayerState": { to_advance: NumberExpression, } } | { "MoveCardsTo": { source: CardCollectionExpression, dest: ZoneExpression, } } | { "Deal": { num_cards: NumberExpression, source: ZoneExpression, dest: ZoneCollectionExpression, } } | { "Shuffle": ZoneCollectionExpression } | { "EnterPhase": string } | { "Offer": Offer };
